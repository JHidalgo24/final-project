    ...
    return (<ImageBackground source={require('../assets/wallpaper.jpg')}>
        <ScrollView>
            <View>
                ...
                <Text style={{textAlign: 'center', color: '#718FE6', padding: 20}} category='h4'>
                ...
                <Card style={styles.card}>
                    ...
                    <Text style={{textAlign: 'center'}} category='h6'>
                        Here you will be able to find cool new animes to watch and add them to your own watchlist to
                ...
                <Card style={styles.card}>
                    ...
                    <Text style={{textAlign: 'center'}} category='h6'>
                        In the app you should be able to sign up, add items to your watchlist, and even simply
                        search up basic information about the anime. The API being used is Jikan V4 API.
                    </Text>
