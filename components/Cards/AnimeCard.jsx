...
import { Card, Divider, Modal, Text } from "@ui-kitten/components";
          ...
          <View style={styles.buttonGroupThing} level="1">
            ...
            >
              <Text style={styles.buttonText}>
                More Info{" "}
                <MaterialCommunityIcons name="information"></MaterialCommunityIcons>
              </Text>
            </TouchableOpacity>

            {inWatched || props.user === null ? (
              <TouchableOpacity
                color="#EE8AF8"
                onPress={() => {
                  addToWatched();
                }}
                disabled={props.user === null || inWatched}
              >
                <Text style={styles.buttonTextDisabled}>
                  Watched{" "}
                  <MaterialCommunityIcons name="book-plus"></MaterialCommunityIcons>
                </Text>
              </TouchableOpacity>
            ) : (
              <TouchableOpacity
            ...
            {inWatchlist || props.user === null ? (
              <TouchableOpacity
                color="#EE8AF8"
                onPress={() => {
                  addToWatchList();
                }}
                disabled={props.user === null || inWatchlist}
              >
                <Text style={styles.buttonTextDisabled}>
                  WatchList{" "}
                  <MaterialCommunityIcons name="book-plus"></MaterialCommunityIcons>
          ...
          <Card style={{ borderRadius: 20 }}>
            <ScrollView>
              ...
              <Text style={styles.description} category={"h6"}>
                {props.item.synopsis === null
                  ? "There was no synopsis provided for this title."
                  : props.item.synopsis}
              </Text>
