    ...
    if (props.user !== null) {
      ...
      await db
        ...
        .add({
          ...
          PostContent: content,
          uid: userThingy.uid,
          displayName: userThingy.displayName,
          userImage: userThingy.photoURL,
          email: userThingy.email,
        })
        .then(() => {
          setContent("");
          setTitle("");
      ...
      >
        {isFocused ? (
          <ScrollView>
            ...
            >
              ...
              {displayNameMissing ? (
                <Text style={styles.missingInfo}>
                  You don't have a name for your account. Set one in the Account
                  Page
                </Text>
              ) : null}
              {photoURLMissing ? (
                <Text style={styles.missingInfo}>
                  You are Missing an image please add one to your account
                </Text>
              ) : null}
              <TouchableOpacity>
                <Text
            ...
            <ScrollView>
              <Text
                style={{ textAlign: "center", marginTop: 15, marginBottom: 0 }}
                category={"h2"}
              >
                Recent Posts{" "}
                <TouchableOpacity
